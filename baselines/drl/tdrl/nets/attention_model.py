...
class AttentionModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.vehicleGRUUpdater = VehicleGRUUpdater(paramet_ahasp.ROBOT_NUM, embedding_dim, hidden_dim)
        ...
        self.context_update_linear = nn.Linear(paramet_ahasp.ROBOT_NUM * 3, embedding_dim, bias=False)
        ...
        self.robot_update_embedding_linear = nn.Linear(3, embedding_dim, bias=False)
    ...
    def robot_update_embed(self, state):
        ...
        # robot_update_embedding = self.robot_update_embedding_linear(robot_init_info)
        return C_en_t_info
